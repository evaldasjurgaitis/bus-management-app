...
@EnableJpaRepositories(
        basePackages = {
                ...
                "ej.domain.projection.repository"},
        entityManagerFactoryRef = "projectionEntityManagerFactory",
        transactionManagerRef = "projectionTransactionManager"
)
@EntityScan(basePackages = {
        "ej.domain.projection.entity",
        "ej.idempotent.entity"
})
public class PersistenceCustomerServiceConfiguration {

    @Bean
    @ConfigurationProperties(prefix = "spring.bms-customer-service.datasource")
